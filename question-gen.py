...
generated_questions = generate_questions(text_pairs[:10], model, tokenizer)

for fact, question in zip(text_pairs, generated_questions):
    print(f"\nFact: {fact[0]}")
